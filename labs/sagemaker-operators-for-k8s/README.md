...
Look up the path for the `model.tar.gz` file generated by the training job in the AWS S3 Console(You can find the model file inside the `output` folder in the S3 bucket.
